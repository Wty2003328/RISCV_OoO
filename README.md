...
While the exact grading criteria is TBD, the overall split of the points in this
section will be 15 points allocated based on implementing features detailed in
...
deliverables.  The `main` branch wlil be used by the AG for performance testing,
